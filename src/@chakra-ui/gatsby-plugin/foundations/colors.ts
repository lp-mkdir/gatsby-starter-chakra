...
const colors = {
  brand: {
    ...
    textEmphasized: colorPalette.colors.orange[`600`],
    heading: colorPalette.colors.black,
    bg: colorPalette.colors.gray[`50`],
    bgAlpha: transparentize(`gray[50]`, navBgTransparency)(colorPalette),
    cardBg: colorPalette.colors.white,
    cardSubheading: colorPalette.colors.coolGray[`700`],
  },
  ...colorPalette.colors,
}
